...
const Publish = ({ initialData }: PublishProps) => {
    ...
    const onUnPublish = () =>{
        ...
        toast.promise(promise, {
            loading: "Removing Published note...",
            success: "Removed Published Note!",
            error: "Failed to remove publish note"
        })
    }
                ...
                {initialData.isPublished ? (
                    <div className='space-y-4'>
                        ...
                        <div className='flex items-center'>
                            ...
                            <Button onClick={onCopy} disabled={copied} className='h-8 rounded-l-none'>{copied ? (<Check className='h-4 w-4' />) : (<Copy className='h-4 w-4' />) }</Button>
                        </div>
